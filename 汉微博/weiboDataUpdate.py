...
for page_num in range(1, 9999):
    ...
    page_url = 'https://weibo.com/suodj?pids=Pl_Official_MyProfileFeed__21&is_search=0&visible=0&is_all=1&is_tag=0&profile_ftype=1&page='
    ...
    for weibo_detail in weibo_details:
        ...
        #跳过不是本账号的微博(点赞的微博)
        weibo_info_item = weibo_detail.find_element_by_css_selector('.WB_info')
        if weibo_info_item.find_element_by_tag_name('a').text.find("索达吉堪布") == -1:
            continue
